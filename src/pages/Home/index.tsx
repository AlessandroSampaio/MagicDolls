    ...
    <nav className='bg-white shadow-lg'>
      <div className="max-w-6xl mx-auto px4">
        <div className="flex justify-between w-full ">
          <div className="flex space-x-7 w-full">
            ...
            <div className='hidden md:flex items-center space-x-1'>
              ...
              <a href="/" className="py-4 px-2 text-primary border-b-4 border-primary-dark font-semibold">Sobre nós</a>
            </div>
        ...
        <div className={`${isNavOpen ? '' : 'hidden'}`}>
          ...
          <a href="" className='py-2 pl-2 text-primary-dark hover:bg-primary-light hover:text-white block'>Sobre nós</a>
        </div>
      </div>
    </nav>
  );

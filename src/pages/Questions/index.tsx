...
export default function Questions() {
  ...
  return (
    <>
      ...
      <Accordion open={open === 2} placeholder='Duvidas'>
        <AccordionHeader
      ...
      <Accordion open={open === 3} placeholder='Duvidas'>
        <AccordionHeader
      ...
      <Accordion open={open === 4} placeholder='Duvidas'>
        <AccordionHeader
      ...
      <Accordion open={open === 5} placeholder='Duvidas'>
        <AccordionHeader
        ...
        <AccordionBody
          ...
          className='text-sm font-normal px-4'
        >
          <b>1.</b> Reembolso total: O cliente receberá um reembolso integral do valor pago pela peça.
          <br />
